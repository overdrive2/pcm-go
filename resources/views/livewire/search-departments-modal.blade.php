<div>
    ...
    <div class="w-full">
        <div class="bg-white rounded-lg border border-gray-200 text-gray-900 w-full">
            @foreach($rows as $key => $row)
            <button type="button" wire:click="$emit('set:fromdept', '{{$row->dept_id}}')" class="
                text-left
                px-6
                py-2
