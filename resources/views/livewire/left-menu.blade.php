<div
        ...
        <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
            <ul class="pb-2 space-y-2">
                ...
                <li>
                    <button type="button"
                        ...
                        aria-controls="dropdown-plans" data-collapse-toggle="dropdown-plans" aria-expanded="{{ (request()->routeIs('plan.request')||request()->routeIs('plan.movement')) ? 'true' : 'false' }}">
                        <i
                            class="fa-solid fa-square-parking flex-shrink-0 text-2xl text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"></i>
                        <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">แผนจัดซื้อจัดจ้าง</span>
                    ...
                    <ul id="dropdown-plans" class="py-2 space-y-2 {{ (request()->routeIs('plan.request')||request()->routeIs('plan.movement')) ? '':'hidden' }}">
                        <li>
                            <a href="{{ route('plan.request') }}"
                                class="{{ request()->routeIs('plan.request') ? 'dark:bg-gray-700 bg-gray-100':'' }} flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">ใบคำขอ</a>
                        </li>
                        <li>
                            <a href="{{ route('plan.movement') }}"
                                class="{{ request()->routeIs('plan.movement') ? 'dark:bg-gray-700 bg-gray-100':'' }} flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">รายการ</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                        aria-controls="dropdown-order" data-collapse-toggle="dropdown-order" aria-expanded="{{ (request()->routeIs('order.show')||request()->routeIs('order.summary')) ? 'true' : 'false' }}">
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">คำขอซื้อขอจ้าง</span>
                        <svg sidebar-toggle-item="" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                    ...
                    <ul id="dropdown-order" class="space-y-2 py-2 {{ (request()->routeIs('order.show')||request()->routeIs('order.summary')) ? '':'hidden' }}">
                        <li>
                            <a href="{{ route('order.show') }}"
                                class="{{ request()->routeIs('order.show') ? 'dark:bg-gray-700 bg-gray-100':'' }} text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">รายการใบคำขอ</a>
                        </li>
                        <li>
                            <a href="#"
                                class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">ยอดสรุป</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                        aria-controls="dropdown-stock" data-collapse-toggle="dropdown-stock" aria-expanded="{{ (request()->routeIs('stock.header')) ? 'true' : 'false' }}">
                        <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                            aria-hidden="true">
                            <path clip-rule="evenodd" fill-rule="evenodd"
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">คงคลัง</span>
                        <svg sidebar-toggle-item="" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                    ...
                    <ul id="dropdown-stock" class="space-y-2 py-2 {{ (request()->routeIs('stock.header')) ? '':'hidden' }}">
                        <li>
                            <a href="#"
                                class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">จ่าย</a>
                        </li>
                        <li>
                            <a href="{{ route('stock.header') }}"
                                class="{{ request()->routeIs('stock.header') ? 'dark:bg-gray-700 bg-gray-100':'' }} text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">รับ</a>
                        </li>
                    </ul>
                </li>
                <li>
            ...
            <div class="pt-2 space-y-2">
                ...
                <a href="#" target="_blank"
                    ...
                    <span class="ml-3" sidebar-toggle-item="">Configuration</span>
                </a>
                <a href="#" target="_blank"
                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                    <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
    ...
    <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800"
        ...
        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700"
            ...
            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(184px, 367px);">
